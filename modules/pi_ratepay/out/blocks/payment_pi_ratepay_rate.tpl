    ...
    <dd class="[{if $oView->getCheckedPaymentId() == $paymentmethod->oxpayments__oxid->value}]activePayment[{/if}]">
        ...
        <ul class="form">
            ...
            <li>
                ...
                <input name='pi_ratepay_rate_birthdate_day' maxlength='2' type='text' value='' field='small'>
                <input name='pi_ratepay_rate_birthdate_month' maxlength='2' type='text' value='' field='small'>
                <input name='pi_ratepay_rate_birthdate_year' maxlength='4' type='text' value='' field='small'>
